...
import { generateHeliumId, wait } from "common/utils";
...
declare const HELIUM_WEB_ENTRY: string;
declare const HELIUM_PRELOAD_ENTRY: string;
...
export class HeliumWindow {
  ...
  constructor(private options?: HeliumWindowOptions) {
    ...
    const TRAFFIC_LIGHT_HEIGHT = 15; //or 15??
  ...
  private async isThemeFileStructureValid(
    ...
    if (!fse.pathExists(themeService.layoutPath(themePath, "theme.liquid")))
      return false;
